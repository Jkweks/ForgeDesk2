...
## Math scratchpad
Use this section to stage length formulas for upcoming cut-list work:
- door header length = door opening width
- lock jamb door stop = door opening height
- hinge jamb door stop = door opening height
- door head door stop = door opening width - lock jamb door stop LZ - hinge lock jamb LZ (LZ values are pulled from the LZ field of the inventory parts configurator information)
