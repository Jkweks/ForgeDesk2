...
INSERT INTO inventory_items (item, sku, location, stock, status, supplier, supplier_contact, reorder_point, lead_time_days) VALUES
    ('Aluminum Stile - 2"', 'AL-ST-02', 'Aisle 1 / Bin 4', 86, 'In Stock', 'DoorCraft Metals', 'sales@doorcraftmetals.com', 40, 7),
    ('Tempered Glass Panel 36x84', 'GL-3684-T', 'Aisle 3 / Rack 2', 24, 'Reorder', 'ClearView Glass', 'orders@clearviewglass.com', 30, 14),
    ('Hinge Set - Heavy Duty', 'HD-HG-SET', 'Aisle 2 / Bin 8', 140, 'In Stock', 'Precision Hardware', 'account@precisionhardware.com', 60, 10),
    ('Threshold Extrusion', 'AL-TH-10', 'Aisle 5 / Bin 1', 12, 'Low', 'Alloy Profiles Inc.', 'support@alloyprofiles.com', 20, 12),
    ('Exit Device Kit', 'EX-KT-44', 'Aisle 4 / Shelf 6', 6, 'Critical', 'SecureLatch Systems', 'rep@securelatchsystems.com', 15, 21)
